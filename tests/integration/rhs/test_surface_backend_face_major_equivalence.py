...
@pytest.mark.parametrize("tau", (0.0, 0.35))
def test_face_major_surface_backend_matches_legacy(tau: float) -> None:
...
@pytest.mark.parametrize("tau", (0.0, 0.35))
def test_face_major_surface_backend_numba_matches_numpy(tau: float) -> None:
...
def test_face_major_surface_backend_matches_legacy_with_split_tau() -> None:
    rule = load_table1_rule(4)
    trace = build_trace_policy(rule)
...
def test_face_major_surface_backend_numba_matches_numpy_with_split_tau() -> None:
    pytest.importorskip("numba")
